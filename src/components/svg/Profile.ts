	...
	return `
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="846" height="423" viewBox="0 0 846 423">
			...
			<g id="card" clip-path="url(#clip-card)">
				...
				<text id="cochumo" transform="translate(269 157)" fill="#bfbfbf" font-size="18" font-family="Poppins-Medium, Poppins" font-weight="500"><tspan x="0" y="0">cochumo</tspan></text>
				<text id="_29" data-name="29" transform="translate(269 198)" fill="#bfbfbf" font-size="18" font-family="Poppins-Medium, Poppins" font-weight="500"><tspan x="0" y="0">29</tspan></text>
				<text id="Japan" transform="translate(269 239)" fill="#bfbfbf" font-size="18" font-family="Poppins-Medium, Poppins" font-weight="500"><tspan x="0" y="0">Japan</tspan></text>
				<text id="Front-end_engineer" data-name="Front-end engineer" transform="translate(268 280)" fill="#bfbfbf" font-size="18" font-family="Poppins-Medium, Poppins" font-weight="500"><tspan x="0" y="0">Front-end engineer</tspan></text>
			</g>
		</svg>
	`
}
